...
var EntityGroup = (function () {
  ...
  proto._fixupKey = function (tempValue, realValue) {
    if (tempValue === realValue) {      //including both null
      return;
    }

    //already updated though foreign key for composite keys
    if (this._indexMap[realValue] != undefined && this._indexMap[tempValue] == undefined) {                    
    return;
    }
