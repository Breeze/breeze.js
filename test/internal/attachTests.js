(function (testFns) {
  ...
  testIfNot("unidirectional attach - n->1",
  ...
  testIfNot("unidirectional attach - 1->n",
    "odata,mongo,hibernate", "does not have TimeList and Timegroup tables", function () {
  ...
  testIfNot("unidirectional attach - 1->n - part 2",
    "odata,mongo,hibernate", "does not have TimeList and Timegroup tables", function () {
  ...
  testIfNot("graph attach (1-n) - piecewise",
    "mongo", "does not have an OrderDetail table", function () {
    var em = newEm();
    var orderType = em.metadataStore.getEntityType("Order");
    var orderDetailType = em.metadataStore.getEntityType("OrderDetail");
  ...
  testIfNot("graph attach (1-n)- all together",
    "mongo", "does not have an OrderDetail table", function () {
  ...
  testIfNot("graph attach (1-n) - all together - autogenerated",
    "mongo", "does not have an OrderDetail table", function () {
