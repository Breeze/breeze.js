(function (testFns) {
  ...
  test("setting another EntityState on a detached entity throws exception", 4, function () {
  ...
  testFns.skipIf("odata,mongo,hibernate", "does not have TimeList and Timegroup tables").
