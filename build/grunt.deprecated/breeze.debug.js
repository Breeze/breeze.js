...
;var createAltPredicate = (function () {
    ...
    var UnaryPredicate = (function(op, node) {
        ...
        proto.validate = function (entityType) {
            ...
            this._validatedEntityType = entity;
        };
    ...
    var BinaryPredicate = (function() {
        ...
        proto.validate = function (entityType) {
            ...
            if (this.expr1 == null) {
                throw new Error("Unable to validate: " + this.expr1Source);
            }
            this.expr2 = createExpr(this.expr2Source, entityType, this.op);
            if (this.expr2 == null) {
                throw new Error("Unable to validate: " + this.expr2Source);
            }
            this._validatedEntityType = entity;
        };
    ...
    function parseLitOrPropExpr(value, entityType) {
        ...
        if (isQuoted) {
            return new LitExpr(value, isQuoted, DataType.String);
        } else {
            var mayBeIdentifier = RX_IDENTIFIER.test(value);
            if (mayBeIdentifier) {
                if (entityType) {
                ...
                return LitExpr(value, false, DataType.fromValue(value));
            }
        }
    }
